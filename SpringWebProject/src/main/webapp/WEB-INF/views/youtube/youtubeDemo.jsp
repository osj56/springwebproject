...
<!--<![endif]-->
    ...
    <head>
        <title>YouTube API Demo | Carey Development Demos</title>
        <meta content="YouTube API Demo" name="description" />
                            ...
                            <div class="col-md-6 ">
                                <div class="portlet box blue ">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="icon-home"></i>
                                            <span class="caption-subject" style="position:relative;top:2px">YouTube API Demo</span>
                                        </div>
                                    </div>    
                                    <div class="portlet-body form">
                                        <form id="employeeForm" th:action="@{/youtube/youtubeDemo}" th:object="${youtubeSearchCriteria}" method="POST">                                                            
                                        <div class="form-body">
                                            <div>
