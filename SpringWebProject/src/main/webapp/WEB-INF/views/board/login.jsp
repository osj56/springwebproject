...
<body>
	<form:form action="${cp}/loginForm" method="post" commandName="member">
    <div class="container">
        <div class="row">
                        ...
                        <form role="form" >
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="ID" name="memId" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <button class="btn btn-lg btn-success btn-block" type="submit">로그인</button>
         						<a class="btn btn-lg btn-success btn-block" href="${cp}/memjoin">회원가입</a>
