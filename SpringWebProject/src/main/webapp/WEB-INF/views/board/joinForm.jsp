...
<body>
<form:form action="${cp}/join" method="post" commandName="member">
                        ...
                        <form role="form" >
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="ID" name="memId" type="ID" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="memPw" type="password" value="">
                                </div>
                                 <div class="form-group">
                                    <input class="form-control" placeholder="Email" name="memMail" type="Email" value="">
                                </div>
                                
                                <!-- Change this to a button or input when using this as a form -->
                                
                                <button type="submit" class="btn btn-lg btn-success btn-block"  >가입</button>
         						<a class="btn btn-lg btn-success btn-block" type="reset" href="${cp}/">취소</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
